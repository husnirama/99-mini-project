...
type DummyTicketTier = {
  ...
  availability: "paid" | "free";
  price: number;
  capacity: number;
};

type DummyVoucherPromotion = {
  promoName: string;
  voucherCode: string;
  ...
  startDateVoucherEffective: string;
  endDateVoucherEffective: string;
};

type DummyEvent = {
  eventName: string;
  category: "Technology" | "Art" | "Music" | "Business" | "Education";
  location: string;
  eventDescription: string;
  eventCoverImage: string;
  eventStartTime: string;
  eventEndTime: string;
  ticketTiers: DummyTicketTier[];
  picEventName: string;
  picEventEmail: string;
  phoneNumber: string;
...
const dummyEvents: DummyEvent[] = [
  {
    ...
    location: "Jakarta",
    eventDescription:
      "A technology conference focused on artificial intelligence, machine learning, and modern data products. Attendees will join keynote sessions, hands-on workshops, and networking with engineers, founders, and product leaders.",
    eventCoverImage:
  ...
  },
  {
    ...
    location: "Bandung",
    eventDescription:
      "An art and creative market featuring local illustrators, painters, ceramic artists, and handcrafted products. The event includes mini workshops, live sketching sessions, and a curated art showcase.",
    eventCoverImage:
  ...
  },
  {
    ...
    location: "Surabaya",
    eventDescription:
      "A live music event showcasing indie bands, acoustic performers, and emerging local artists. Guests can enjoy a full evening of performances, community interaction, and exclusive merchandise booths.",
    eventCoverImage:
  ...
  },
  {
    ...
    location: "Yogyakarta",
    eventDescription:
      "A business networking forum for startup founders, operators, and investors. The program covers fundraising, product growth, team building, and go-to-market strategy through panels and roundtable discussion.",
    eventCoverImage:
  ...
  },
  {
    ...
    location: "Malang",
    eventDescription:
      "An education fair for students and young professionals with sessions on scholarship opportunities, career preparation, portfolio building, and interview strategy. Universities and training institutions will also open information booths.",
    eventCoverImage:
  ...
  },
  {
    ...
    location: "Denpasar",
    eventDescription:
      "A conference for product managers, designers, and software teams to discuss user experience, experimentation, roadmap planning, and digital product delivery in fast-moving organizations.",
    eventCoverImage:
  ...
  },
  {
    ...
    location: "Semarang",
    eventDescription:
      "A relaxing evening jazz event with local and national performers, food stalls, and outdoor seating. Designed for music lovers seeking a cozy and memorable live performance atmosphere.",
    eventCoverImage:
  ...
  },
  {
    ...
    location: "Makassar",
    eventDescription:
      "A business expo connecting SMEs, corporate professionals, and entrepreneurs through exhibitions, networking sessions, and expert talks on finance, digital transformation, and market expansion.",
    eventCoverImage:
  ...
  },
  {
    ...
    location: "Surakarta",
    eventDescription:
      "A cultural art festival celebrating local heritage through batik exhibitions, traditional performances, contemporary installations, and artisan talks. Suitable for families, creators, and tourists.",
    eventCoverImage:
      "https://images.unsplash.com/photo-1460661419201-fd4cecdf8a8b",
  ...
  },
  {
    ...
    location: "Medan",
    eventDescription:
      "An intensive educational event for aspiring tech talent with sessions on frontend engineering, backend development, data careers, interview preparation, and portfolio review by industry practitioners.",
    eventCoverImage:
...
function getTicketDescription(ticket: DummyTicketTier, category: string) {
...
function getTicketStatus(quota: number) {
  return quota > 0 ? "ACTIVE" : "SOLD_OUT";
}

function getSalesStartAt(eventStartTime: string) {
  const start = new Date(eventStartTime);
  start.setDate(start.getDate() - 30);
  return start;
}

function getSalesEndAt(eventStartTime: string) {
      ...
      await prisma.$transaction(async (tx) => {
        ...
        const createdEvent = await tx.event.create({
          data: {
            ...
            eventTnC:
              "No outside food or beverages. Please show valid ticket at entry.",
            termsAccepted: true,
          },
        });
        ...
        if (dummyEvent.voucherPromotion) {
          await tx.promotion.create({
            data: {
              ...
              discountType: mapPromotionDiscountType(
                dummyEvent.voucherPromotion.discountType,
              ),
              ...
              startDate: new Date(
                dummyEvent.voucherPromotion.startDateVoucherEffective,
              ),
              endDate: new Date(
                dummyEvent.voucherPromotion.endDateVoucherEffective,
              ),
            },
          });
        }
