...
export async function getGrossRevenueLastMonth(
  userId: number,
  eventId: number | string,
) {
  const now = new Date();
...
export async function NumPaidOrders(userId: number, eventId: number | string) {
  if (eventId === "all") {
...
export async function numRejectTransaction(
  userId: number,
  eventId: number | string,
) {
  if (eventId === "all") {
...
export async function seatOccupancy(userId: number, eventId: number | string) {
  if (eventId === "all") {
...
export async function TransactionStatusDetails(
  userId: number,
  eventId: number | string,
) {
  if (eventId === "all") {
