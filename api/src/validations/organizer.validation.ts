...
export type OrganizerProfileUpdateInput = z.infer<
  typeof organizerProfileUpdateSchema
>;

export type OrganizerPasswordUpdateInput = z.infer<
  typeof organizerPasswordUpdateSchema
>;
