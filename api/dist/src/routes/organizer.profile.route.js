...
import { handleGetOrganizerProfile, handleUpdateOrganizerPassword, handleUpdateOrganizerProfile, handleUpdateOrganizerProfilePicture, } from "../controllers/organizer.profile.controller.js";
...
router.patch("/profile/image", requireAuth, requireRole("EVENT_ORGANIZER"), upload.single("image"), handleUpdateOrganizerProfilePicture);
