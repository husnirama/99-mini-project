...
router.get("/:transactionId", optionalAuth, createGetCacheMiddleware({
...
router.patch("/:transactionId/paymentProof", optionalAuth, upload.single("paymentProof"), handleUploadPaymentProof);
