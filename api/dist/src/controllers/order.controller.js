import orderCreation, { previewOrderPricing, } from "../services/order/order.service.js";
import { orderPreviewSchema, orderSchema, } from "../validations/order.validation.js";
...
export async function previewOrderController(req, res, next) {
    try {
