...
import { organizerPasswordUpdateSchema, organizerProfileUpdateSchema, } from "../../validations/organizer.validation.js";
...
async function ensureOrganizerExists(userId) {
...
async function buildOrganizerProfile(userId) {
    const organizer = await prisma.user.findFirst({
        where: {
            id: userId,
            role: "EVENT_ORGANIZER",
...
export async function updateOrganizerProfile(userId, payload) {
...
export async function updateOrganizerPassword(userId, payload) {
    const parsedPayload = organizerPasswordUpdateSchema.parse(payload);
    const organizer = await ensureOrganizerExists(userId);
    const isCurrentPasswordValid = await bcrypt.compare(parsedPayload.currentPassword, organizer.password);
...
export async function updateOrganizerProfilePicture(userId, file) {
...
//# sourceMappingURL=organizer.profile.service.js.map