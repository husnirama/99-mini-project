...
export default function OrganizerSettingPage() {
  ...
  function syncOrganizerProfile(nextProfile: OrganizerProfile) {
  ...
  useEffect(() => {
    ...
    async function fetchProfile() {
      ...
      try {
        ...
        syncOrganizerProfile(nextProfile);
      } catch (error) {
        console.error(error);
  ...
  async function handleUploadProfileImage(
    ...
    try {
      ...
      const response = await apiClient.patch(
        API_ENDPOINTS.ORGANIZER.PROFILE_IMAGE,
        formData,
        {
          headers: {
          ...
          <section className="grid grid-cols-1 gap-8 xl:grid-cols-[1.15fr_0.85fr]">
            <article className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900/60">
              ...
              <div className="mt-8 grid grid-cols-1 gap-5">
                <div className="flex flex-col gap-4 rounded-xl border border-slate-200 bg-slate-50 p-4 dark:border-slate-800 dark:bg-slate-950/30 sm:flex-row sm:items-center sm:justify-between">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">
                        Upload a square image for your organizer account.
                      </p>
                    </div>
                  </div>
